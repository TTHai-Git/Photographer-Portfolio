...
export const endpoints = {
  ...
  updateFolderOrders: "/folders/reorder",
  ...
  getTags: "/tags",
  addMoreTagsForAssets: (assetId) => `/images/${assetId}/tags`,
  replaceAllTagsForAssets: (assetId) => `/images/${assetId}/tags`,
  removeTagsForAssets: (assetId) => `/images/${assetId}/tags`,
  login: "/auth/login",
  logout: "/auth/logout",
  getMe: "/auth/me",
